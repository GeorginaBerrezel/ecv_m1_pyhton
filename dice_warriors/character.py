...
class Character:
    ...
    def fightingCharacters(self):
        return f"{type(self).attack}{self._name}{self._attack_value}"
    
    def __str__(self):
        return self.fightingCharacters()
...
if __name__ == "__main__":
    ...
    layout.split_column(
        Layout(Panel("The combat is starting!", title="🕹️ Welcome PLAYER 🕹️", style="bold cyan on purple")),
        Layout(name="lower"),
        Layout(name="footer"),
)
    layout["lower"].split_row(
        Layout(Panel(char_1.welcomeCharacter(), title="Character 1", style="bold yellow on green")),
        Layout(Panel(char_2.welcomeCharacter(), title="Character 2", style="bold cyan on red")),
)
    
    layout["footer"].split_row(
        Layout(Panel(char_1.fightingCharacters(), title="FIGHTING Character 1")),
        Layout(Panel(char_2.fightingCharacters(), title="FIGHTING Character 2")),
)
